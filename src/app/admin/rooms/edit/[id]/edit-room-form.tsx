...
import { updateRoom } from "@/app/admin/rooms/actions";
...
import { Room_Class, Floor, Room_Status, Room } from "@prisma/client";
import { getRoomClasses } from "@/app/admin/room-class/actions";
import { getRoomStatuses } from "@/app/admin/room-status/actions";
import { getFloors } from "@/app/admin/floors/actions";
import Media from "@/app/admin/media/media";

const CreateRoomForm = ({ room }: { room: Room }) => {
  ...
  const onSubmit = async (formValues: CreateRoomSchemaType) => {
    ...
    const result = await updateRoom(formValues, room.id);
