...
import { createFloorSchema, CreateFloorSchemaType } from "../schema";
...
const CreateFloorForm = () => {
  ...
  const onSubmit = async (formValues: CreateFloorSchemaType) => {
    setMessage(undefined);

    const result = await createFloor(formValues);
      ...
      <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)}>
        <div className="border-b border-border pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-muted-foreground mb-8">
            Fill in the form below to create a new floor
          </p>
