...
import { updateFeature } from "@/app/admin/features/actions";
...
const EditFeatureForm = ({ feature }: { feature: Feature }) => {
  ...
  const onSubmit = async (formValues: z.infer<typeof createFeatureSchema>) => {
    setMessage(undefined);

    const result = await updateFeature(formValues, feature.id);
      ...
      <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)}>
        <div className="border-b border-border pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-muted-foreground mb-8">
            Edit the form below to update the feature
          </p>
