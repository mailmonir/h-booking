...
import { createRoomClass } from "@/app/admin/room-class/actions";
...
const CreateRoomClassForm = ({
  ...
  const form = useForm<z.infer<typeof createRoomClassSchema>>({
    ...
    defaultValues: {
      ...
      image: [],
      features: [],
      bedTypes: [{ bedtype: "", numberOfBeds: "0" }],
    },
  });
  ...
  const onSubmit = async (
    ...
    const result = await createRoomClass(formValues);
              ...
              <FormField
                ...
                render={({ field: { onChange } }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Media onChange={onChange} existingImages={[]} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
